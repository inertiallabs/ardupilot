...
const AP_Param::GroupInfo AP_ExternalAHRS::var_info[] = {
    ...
    // @Bitmask: 0:Vector Nav use uncompensated values for accel gyro and mag, 1:SBG uses EKF as GNSS, 2:SensAItion used as AHRS, 3:Transmit airspeed to IL INS, 4:Send IL INS status messages to GCS, 5:Reserved, 6:Use IL INS true airspeed
    // @User: Standard
...
bool AP_ExternalAHRS::get_wind_estimation(Vector3f &wind) const
{
    if (backend) {
