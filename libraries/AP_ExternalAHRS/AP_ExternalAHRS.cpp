...
const AP_Param::GroupInfo AP_ExternalAHRS::var_info[] = {
    ...
    // @Bitmask: 0:Vector Nav use uncompensated values for accel gyro and mag, 1:Transmit airspeed to IL INS, 2:Send IL INS status messages to GCS, 3:Reserved, 4:Use IL INS true airspeed
    // @User: Standard
